                                    ...
                                    return [
                                        {
                                            ...
                                            _debugInfo: {
                                                fedConfig: `
{"_NAME_":"VALID_CONTEXT_LOCATION_COUNTRY_CODE","attr":"$.context.location.country.code","enumList":["IND2"],"_RETURN_":"attr any in enumList","action":["rating"],"domain":["ONDC:TRV14"],"version":["2.0.0"]}
`,
                                            },
                                        },
                                    ];
                            ...
                            return [
                                {
                                    ...
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition RATING_CATEGORY**: $.message.ratings[*].rating_category must be present in the payload`,
                                    _debugInfo: {
                                        fedConfig: `
                            ...
                            return [
                                {
                                    ...
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition RATING_ID**: $.message.ratings[*].id must be present in the payload`,
                                    _debugInfo: {
                                        fedConfig: `
                            ...
                            return [
                                {
                                    ...
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition RATING_VALUE**: $.message.ratings[*].value must be present in the payload`,
                                    _debugInfo: {
                                        fedConfig: `
